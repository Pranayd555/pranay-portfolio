...
import { AboutParticleBgComponent } from './about-particle-bg.component';
...
describe('AboutParticleBgComponent', () => {
  beforeEach(async () => {
  ...
  it('should create', () => {
    const fixture = TestBed.createComponent(AboutParticleBgComponent);
